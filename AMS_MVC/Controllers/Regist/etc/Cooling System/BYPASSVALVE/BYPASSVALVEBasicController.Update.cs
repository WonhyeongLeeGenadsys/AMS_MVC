...
namespace AMS_MVC
{
    public partial class BYPASSVALVEBasicController : Controller
    {
        ...
        [HttpGet]
        public ActionResult UpdateBYPASSVALVEBasic(string tblIdx)
        {
            var model = bypassvalveBasicRepository.GetBYPASSVALVEBasicInfoByTblIdxRepo(tblIdx);
            if (model == null)
            {
            ...
            return View("~/Views/Regist/etc/Cooling System/BYPASSVALVE/BYPASSVALVEBasicUpdate.cshtml", model);
        }

        // POST: 수정 요청 처리
        [HttpPost]
        public ActionResult UpdateBYPASSVALVEBasicInfo(BYPASSVALVEBasicInfo model, HttpPostedFileBase photo)
        {
            ...
            var result = bypassvalveBasicRepository.UpdateBYPASSVALVEBasicInfoRepo(model);
