...
namespace AMS_MVC.Controllers
{
    public partial class ESBasicController : Controller
    {
        ...
        [HttpGet]
        public ActionResult UpdateESBasic(string tblIdx)
        {
            var model = esBasicRepository.GetESBasicInfoByTblIdxRepo(tblIdx);
            if (model == null)
            {
            ...
            return View("~/Views/Regist/etc/Grounding/ES/ESBasicUpdate.cshtml", model);
        }

        // POST: 수정 요청 처리
        [HttpPost]
        public ActionResult UpdateESBasicInfo(ESBasicInfo model, HttpPostedFileBase photo)
        {
            ...
            var result = esBasicRepository.UpdateESBasicInfoRepo(model);
