...
namespace AMS_MVC.Controllers
{
    public partial class DSBasicController : Controller
    {
        ...
        [HttpGet]
        public ActionResult UpdateDSBasic(string tblIdx)
        {
            var model = dsBasicRepository.GetDSBasicInfoByTblIdxRepo(tblIdx);
            if (model == null)
            {
            ...
            return View("~/Views/Regist/etc/AC Yard/DS/DSBasicUpdate.cshtml", model);
        }

        // POST: 수정 요청 처리
        [HttpPost]
        public ActionResult UpdateDSBasicInfo(DSBasicInfo model, HttpPostedFileBase photo)
        {
            ...
            var result = dsBasicRepository.UpdateDSBasicInfoRepo(model);
