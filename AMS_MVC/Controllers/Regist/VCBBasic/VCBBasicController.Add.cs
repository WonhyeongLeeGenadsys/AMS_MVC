...
namespace AMS_MVC.Controllers
{
    ...
    {
        [HttpGet]
        public ActionResult VCBBasicAdd()
        {
            ...
            return View("~/Views/Regist/VCB/VCBBasicAdd.cshtml");
        }

        [HttpPost]
        public ActionResult VCBBasicAdd(VCBBasicInfo model, HttpPostedFileBase photo)
        {
            // 이미지 업로드 처리 
        ...
        private static string GenerateNextVCBCode(string latestCode, string prefix)
        {
            int codeNumber = 0;
