...
namespace AMS_MVC.Controllers
{
    public partial class VCBBasicController : Controller
    {
        ...
        [HttpGet]
        public ActionResult UpdateVCBBasic(string tblIdx)
        {
            var model = vcbBasicRepository.GetVCBBasicInfoByTblIdxRepo(tblIdx);
            if (model == null)
            {
            ...
            return View("~/Views/Regist/VCB/VCBBasicUpdate.cshtml", model);
        }

        // POST: 수정 요청 처리
        [HttpPost]
        public ActionResult UpdateVCBBasicInfo(VCBBasicInfo model, HttpPostedFileBase photo)
        {
