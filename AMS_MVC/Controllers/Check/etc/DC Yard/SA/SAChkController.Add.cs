...
namespace AMS_MVC.Controllers.Check
{
    ...
    {
        public ActionResult SAChkAdd(string SA_Code)
        {
            // 선택한 SA의 기본정보 조회
            ...
            return View("~/Views/Check/etc/DC Yard/SA/SAChkAdd.cshtml");
        }

        [HttpPost]
        public ActionResult SAChkAdd(SAChk model)
        {
            ...
            try
            {
                ...
                result = saChkRepository.CreateSAChkRepo(model);
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog("SAChkAdd Error", ex.Message);
            }
