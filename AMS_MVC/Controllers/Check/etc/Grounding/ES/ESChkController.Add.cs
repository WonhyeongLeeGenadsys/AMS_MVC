...
namespace AMS_MVC.Controllers.Check
{
    ...
    {
        public ActionResult ESChkAdd(string ES_Code)
        {
            // 선택한 ES의 기본정보 조회
            ...
            return View("~/Views/Check/etc/Grounding/ES/ESChkAdd.cshtml");
        }

        [HttpPost]
        public ActionResult ESChkAdd(ESChk model)
        {
            ...
            try
            {
                ...
                result = esChkRepository.CreateESChkRepo(model);
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog("ESChkAdd Error", ex.Message);
            }
