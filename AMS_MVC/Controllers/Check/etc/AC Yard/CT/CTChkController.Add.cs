...
namespace AMS_MVC.Controllers.Check
{
    ...
    {
        public ActionResult CTChkAdd(string CT_Code)
        {
            // 선택한 CT의 기본정보 조회
            ...
            return View("~/Views/Check/etc/AC Yard/CT/CTChkAdd.cshtml");
        }

        [HttpPost]
        public ActionResult CTChkAdd(CTChk model)
        {
            ...
            try
            {
                ...
                result = ctChkRepository.CreateCTChkRepo(model);
            }
            catch (Exception ex)
            {
                result.IsSuccess = false;
                result.Message = $"오류 발생: {ex.Message}";
                LogHelper.WriteLog("CTChkAdd Error", ex.Message);
            }
