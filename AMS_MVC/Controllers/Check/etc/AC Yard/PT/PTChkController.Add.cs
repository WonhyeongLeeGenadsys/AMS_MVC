...
namespace AMS_MVC.Controllers.Check
{
    ...
    {
        public ActionResult PTChkAdd(string PT_Code)
        {
            // 선택한 PT의 기본정보 조회
            ...
            return View("~/Views/Check/etc/AC Yard/PT/PTChkAdd.cshtml");
        }

        [HttpPost]
        public ActionResult PTChkAdd(PTChk model)
        {
            ...
            try
            {
                ...
                result = ptChkRepository.CreatePTChkRepo(model);
            }
            catch (Exception ex)
            {
                result.IsSuccess = false;
                result.Message = $"오류 발생: {ex.Message}";
                LogHelper.WriteLog("PTChkAdd Error", ex.Message);
            }
