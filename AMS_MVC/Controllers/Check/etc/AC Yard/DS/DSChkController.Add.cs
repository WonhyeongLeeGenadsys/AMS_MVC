...
namespace AMS_MVC.Controllers.Check
{
    ...
    {
        public ActionResult DSChkAdd(string DS_Code)
        {
            // 선택한 DS의 기본정보 조회
            ...
            return View("~/Views/Check/etc/AC Yard/DS/DSChkAdd.cshtml");
        }

        [HttpPost]
        public ActionResult DSChkAdd(DSChk model)
        {
            ...
            try
            {
                ...
                result = dsChkRepository.CreateDSChkRepo(model);
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog("DSChkAdd Error", ex.Message);
            }
