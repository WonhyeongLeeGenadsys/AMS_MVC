    ...
    public partial class DCCABLEChkController : Controller
    {
        ...
        public ActionResult DCCABLEChkAdd(DCCABLEChk model)
        {
            ...
            try
            {
                ...
                //DCCABLEChkScoreCalculator scoreCalculator = new DCCABLEChkScoreCalculator();
                ...
                {
                    // HI(건전도)를 Riskmatrix에 업데이트: model.DCCABLE_Code에 대해 FoldingFunction 값을 HI에 넣는다.
                    //Result updateResult = riskMatrixRepository.UpdateRiskMatrixHI(model.DCCABLE_Code, model.FoldingFunction);
                    Result updateResult = riskMatrixRepository.UpdateRiskMatrixHI(model.DCCABLE_Code, (int)System.Math.Round(hi), pof);
