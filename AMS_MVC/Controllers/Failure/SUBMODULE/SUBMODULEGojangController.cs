...
namespace AMS_MVC.Controllers
{
    public partial class SUBMODULEGojangController : Controller
    {
        ...
        private readonly SUBMODULEGojangRepository submoduleGojangRepository;
        private readonly SUBMODULEBasicInfoRepository submoduleBasicInfoRepository;

        public SUBMODULEGojangController()
        {
            ViewBag.MenuType = "Gojang";
            companyRepository = new CompanyRepository();
            gojangRepository = new GojangRepository();
            submoduleGojangRepository = new SUBMODULEGojangRepository();
