...
namespace AMS_MVC
{
    ...
    {
        public ActionResult BYPASSVALVEGojangAdd(string BYPASSVALVE_Code)
        {
            ...
            return View("~/Views/Gojang/etc/Cooling System/BYPASSVALVE/BYPASSVALVEGojangAdd.cshtml");
        }

        [HttpPost]
        public ActionResult BYPASSVALVEGojangAdd(BYPASSVALVEFailureHistory model)
        {
            ...
            try
            {
                ...
                result = bypassvalveGojangRepository.CreateBYPASSVALVEFHRepo(model);

                if (!result.IsSuccess)
                {
                    result.Message = "BYPASSVALVE 고장이력 정보를 추가하지 못했습니다.";
                }
            }
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog("BYPASSVALVEGojangAdd Error", ex.Message);
            }
