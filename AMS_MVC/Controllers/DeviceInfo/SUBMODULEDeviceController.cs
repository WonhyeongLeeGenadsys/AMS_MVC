...
namespace AMS_MVC.Controllers
{
    public class SUBMODULEDeviceController : Controller
    {
        ...
        public JsonResult GetPrioritySUBMODULE()
        {
            try
            {
                var priorityData = _priorityRepo.GetPriority("SUBMODULE_BASICINFO", "SUBMODULE_CODE", "SUBMODULE", "SUBMODULE");
        ...
        public JsonResult GetGojangSUBMODULEList()
        {
            try
            {
                var gojangData = _gojangRepo.GetGojangData("SUBMODULE_FAILURE_HISTORY", "SUBMODULE_BASICINFO", "SUBMODULE_CODE", "SUBMODULE", "SUBMODULE");
