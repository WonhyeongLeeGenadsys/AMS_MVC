    ...
    public class ITRChk2Repository
    {
        ...
        public Result GetITRChk1ByITRCode(string itrCode, out List<ITRChk2> itrChk2List)
        {
            ...
            try
            {
                ...
                {
                    const string query = "SELECT * FROM INTERFACETR_CHK2 WHERE ITR_CODE = @ITR_Code";
        ...
        public Result GetTotalITRChk2(out List<ITRChk2> itrChkList)
        {
            ...
            try
            {
                using(DBHelper dbHelper = new DBHelper())
                {
                    const string query = "SELECT * FROM INTERFACETR_CHK2";
        ...
        public Result DeleteITRChk2InfoRepo(string itrCode, string tblIdx)
        {
            ...
            try
            {
                using(DBHelper dbHelper = new DBHelper())
                {
                    const string query = "DELETE FROM INTERFACETR_CHK2 WHERE ITR_CODE = @ITR_Code AND TBL_IDX = @Tbl_Idx";
