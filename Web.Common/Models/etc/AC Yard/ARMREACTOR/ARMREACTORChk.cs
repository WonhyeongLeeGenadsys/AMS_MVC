...
namespace Web.Common
{
    public class ARMREACTORChk
    {
        ...
        public string CHK_12_1 { get; set; } // OLTC 절연유의 절연내력 시험 (진공형)
        ...
        public string CHK_8_1_Text => ToStatusText(CHK_8_1);
        public string CHK_9_1_Text => ToStatusText(CHK_9_1);
        public string CHK_10_1_Text => ToStatusText(CHK_10_1);
        public string CHK_11_1_Text => ToStatusText(CHK_11_1);
        public string CHK_12_1_Text => ToStatusText(CHK_12_1);
        public string CHK_13_1_Text => ToStatusText(CHK_13_1);
    }
}
