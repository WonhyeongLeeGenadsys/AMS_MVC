                ...
                using (var conn = dbHelper.Conn)
                {
                    using (var transaction = conn.BeginTransaction())
                    {
                        ...
                        INSERT INTO DCCB_CHK (
                            ...
                            CHK_MAINCIRCUIT_PD,
                            CHK_MACHINE_PART_OPERATION_TIME,
                            CHK_MECHANICAL_VIBRATION_ACCELERATION,
                            CHK_RELAY_AUXILIARY_CONTACT_RESISTANCE,
                            CHK_CE_VOLTAGE,
                            CHK_G_VOLTAGE,
                            CHK_C_CURRENT,
                            CHK_ONOFF_TIME,
        ...
        public Result UpdateDCCBChkRepo(DCCBChk dccbChk)
        {
            ...
            try
            {
                ...
                SET 
                    ...
                    CHK_MAINCIRCUIT_PD = @CHK_MainCircuit_PD,
                    CHK_MACHINE_PART_OPERATION_TIME = @CHK_Machine_Part_Operation_Time,
                    CHK_MECHANICAL_VIBRATION_ACCELERATION = @CHK_Mechanical_Vibration_acceleration,
                    CHK_RELAY_AUXILIARY_CONTACT_RESISTANCE = @CHK_Relay_Auxiliary_Contact_Resistance,
